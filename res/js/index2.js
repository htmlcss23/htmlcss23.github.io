window.onload = function(){
	...
	function drag(obj){	              
		obj.onmousedown = function(ev){	
			...
			//zpub.bind(document,'mousemove',fn1);
			...
			function fn2(ev){
				...
				//zpub.unBind(document,'mousemove',fn1);
				//zpub.unBind(document,'mouseup',fn2);	
				document.onmousemove = document.onmouseup = null;			
				if( obj.releaseCapture ){
					obj.releaseCapture();
				}				
			}
		    //zpub.bind(document,'mouseup',fn2);
			...
			document.onmouseup = function(){
				...
				function allDrag(){
					...
					function drag2(obj){
						...
						//zpub.bind(obj,'mousedown',totalFn1)					
						function totalFn1(ev){
							...
							//zpub.bind(document,'mousemove',totalFn2);
							...
							//zpub.bind(document,'mouseup',totalFn3);
							document.onmouseup = totalFn3;
							function totalFn3(ev){
								var e = ev || event;
								e.cancelBubble = true;
								arrTotal = [];
								arrTotal2=[];
								//zpub.unBind(document,'mousemove',totalFn2);
								//zpub.unBind(document,'mouseup',totalFn3);
								document.onmousemove = document.onmouseup = null;
